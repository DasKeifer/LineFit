 ...
 * PARTICULAR PURPOSE. See the GNU Affero General License for more details. You should have received a copy of the GNU
 * Affero General License along with this program. If not, see http://www.gnu.org/licenses/. */
package linefit;
