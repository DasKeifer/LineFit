...
/**
 * This class Creates the Table Model for the GraphSet's data and controls the behavior for the GraphSet data table 
 * so that we can remove columns and see if it is empty
 * 
 * @author	Unknown
 * @version	1.0
 * @since 	&lt;0.98.0
