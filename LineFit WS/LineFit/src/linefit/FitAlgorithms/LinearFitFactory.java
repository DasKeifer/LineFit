...
/**
 * The Abstract class for the Linear Fit Algorithms that allows the user to select the the fit algorithm during fun time
 * @author Keith Rice
 * @version	1.0
 * @since 	0.98.1
 */
public abstract class LinearFitFactory 
{
	 ...
	 * find the algorithm with the passed name, it will use the default algorithm position at 0 in the array
	 * @param passedName The name of the algorithm to get in the list of possible linear fit factories
	 * @return Returns the Linear fit factory that has the passed name as its toString method or the default factory if the passed name is
	 * not found in the array of fit factories
	 */
	...
	/** Whether or not the fit algorithm generated by this factory supports fixing the slope of the fit. Set to false by default */
	protected boolean canGeneratedFitsFixSlope = false;
	/** Whether or not the fit algorithm generated by this factory supports fixing the intercept of the fit. Set to false by default */
