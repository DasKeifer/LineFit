...
//Maybe add mouse functionality like in: http://stackoverflow.com/questions/22622973/jtable-copy-and-paste-using-clipboard-and-abstractaction
 ...
 * 
 * This code is based on the ExcelAdapter from JavaWorld and is used per their (IDG) copyright policy as of 2015 and has since
 * been modified by Covenant College Students to work with other platforms
 * 
 ...
 * 
 * Allowed use of source code from http://www.javaworld.com/about/copyright.html on 2/16/2015 copied below for convenience:
 * Permissions
 * Content derived from JavaWorld may be reproduced in print or displayed online and distributed, for free, in limited quantities for nonprofit, 
 * educational purposes with proper attribution. IDG retains the copyright for any such use. Any use of whole or partial JavaWorld content intended 
 * to endorse a product or for other commercial use must be approved by a JavaWorld editor. Requests will be acted on quickly. For any 
 * commercial reproduction of JavaWorld content, print or online, you must purchase a reprint. 
 * 
...
public class SpreadSheetAdapter implements ActionListener 
{
	...
	public SpreadSheetAdapter(JTable tableToListenOn) 
	{
		...
		KeyStroke selectAll = KeyStroke.getKeyStroke(KeyEvent.VK_A, Toolkit.getDefaultToolkit().getMenuShortcutKeyMask(), false);
	...
	public void copy() 
	{
		...
		if (!((numberOfRows - 1 == rowsselected[rowsselected.length - 1]
				- rowsselected[0] && numberOfRows == rowsselected.length) && (numberOfColumns - 1 == colsselected[colsselected.length - 1]
		...
		for (int currentRow = 0; currentRow < numberOfRows; currentRow++) 
		{
			...
			{
				copiedCellsAsStrings.append(tableActedOn.getValueAt(rowsselected[currentRow],colsselected[currentColumn]));
	...
	/**
	 * The action listener that is triggered when one of our defined keystrokes are pressed which then calls an appropriate function
	 * to do the work
	 */
	public void actionPerformed(ActionEvent e) 
	{
		switch(e.getActionCommand())
		{
			...
			case "all": tableActedOn.selectAll(); break;
