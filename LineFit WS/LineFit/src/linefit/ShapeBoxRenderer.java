...
{	
	...
	public void paint(Graphics g) 
	{
		...
		{
			ellipse.setFrame(ourDimensions.width / 2 - shapesize / 2, ourDimensions.height / 2 - shapesize / 2, shapesize, shapesize);
		...
		{
        	rectangle.setFrame(ourDimensions.width / 2 - shapesize / 2, ourDimensions.height / 2 - shapesize / 2, shapesize, shapesize);
