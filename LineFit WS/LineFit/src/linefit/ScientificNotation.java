...
/**
 * This class contains helper functions that converts numbers as doubles to a
 ...
 * <li>n = power
 * </ul>
 * Also, the functions round relative to the decimal place. If roundTo is negative
 * it will round to the left of the decimal point
 * 
 * @author	Keith Rice
 * @version	1.0.1
 * @since 	&lt;0.98.0
...
{
	/**
	 * Converts the number (double) with the given error value (double) into scientific notation, rounded to the given decimal
	 * place (relative to the decimal point) using ASCII characters.
	 * Returns in the form: (a ± b)×10^n
	 * 
	 ...
	 * @param roundTo	The decimal places after the decimal point to round to (negative rounds to the right of the decimal)
	...
	/**
	 * Converts the number (double) with the given error value (double) into scientific notation with the ten to the given 
	 * power, rounded to the given decimal place (relative to the decimal point) using ASCII characters.
	 * Returns in the form: (a ± b)×10^n 
	 * 
	 * @param number	The number to be converted to scientific notation and rounded
	 * @param error		The error or uncertainty that is associated with the number to be put in scientific notation
	...
	/**
	 * Converts the number (double) with the given error value (double) into scientific notation, rounded to the given decimal
	 * place (relative to the decimal point) for use in LaTex.
	 * Returns in LaTex in the form: (a ± b)×10^n
	 * 
	 * @param number	The number to be converted to scientific notation and rounded
	 * @param error		The error or uncertainty that is associated with the number to be put in scientific notation
	 * @param roundTo	The decimal places after the decimal point to round to (negative rounds to the right of the decimal)
	...
	/**
	 * Converts the number (double) with the given error value (double) into scientific notation with the ten to the given 
	 * power, rounded to the given decimal place (relative to the decimal point) for use in LaTex.
	 * Returns in LaTex in the form: (a ± b)×10^n 
	 * 
	 * @param number	The number to be converted to scientific notation and rounded
	 * @param error		The error or uncertainty that is associated with the number to be put in scientific notation
	 ...
	 * @param roundTo	The decimal places after the decimal point to round to (negative rounds to the right of the decimal)
	 * @return			Returns a string formatted for use in LaTex of the number with the given error in scientific notation 
	 * 					and the given power rounded to the given decimal place in the following form: (a ± b)×10^n
	 */
	...
	/**
	 * Converts the number (double) with no associated error/uncertainty value into scientific notation with the ten to the 
	 * given power, rounded to the given decimal place (relative to the decimal point) using ASCII characters.
	 * Returns in LaTex in the form: a×10^n
	 * 
	 * @param number	The number to be converted to scientific notation and rounded
	 * @param power		The power to use for ^n in scientific notation
	 * @param roundTo	The decimal places after the decimal point to round to (negative rounds to the right of the decimal)
	 * @return			Returns an ASCII string of the number in scientific notation with the given power rounded to the 
	 * 					given decimal place in the following form: a×10^n
	 */
	...
	/**
	 * Converts the number (double) with no associated error/uncertainty and with no times ten to a power. This prevents
	 * the conversion to a string from having an 'E' or x10 in it
	 * Returns in the form: a
	 * 
	...
	/**
	 * Converts the number into scientific notation with the given power, but only returns the base number part of it without its power
	 * Return in the form: a
	 * 
	 * @param number	The number to be converted to scientific notation and rounded
	 * @param power		The power to use for ^n in scientific notation
	...
	/**
	 * Returns the given number's times ten to the n power 
	 * Returns in the form: ×10^n
	 * 
	...
	/**
	 * Returns a string of times ten to the given power 
	 * Returns in the form: ×10^n
	 * 
	...
	public static String onlyTimesTen(int power)	
	{
		...
		if(power != 0) 
		{
			...
			for(int j = 0; j < tmpPow.length(); j++) 
			{
				...
				{
					case '0': powerString += '\u2070';break;
					case '1': powerString += '\u00B9';break;
					case '2': powerString += '\u00B2';break;
					case '3': powerString += '\u00B3';break;
					case '4': powerString += '\u2074';break;
					case '5': powerString += '\u2075';break;
					case '6': powerString += '\u2076';break;
					case '7': powerString += '\u2077';break;
					case '8': powerString += '\u2078';break;
					case '9': powerString += '\u2079';break;
				}
			}
		}
		return powerString;
	...
	/**
	 * Returns a string of times ten to the given power 
	 * Returns in Latex in the form: ×10^n
	 * 
	 * @param power		The power to use for the times ten
	 * @return			Returns a string of the times ten to the given power
	 */
	...
	/**
	 * Rounds a number (in string form) to a specified number of places, which is centered on the decimal place 
	 *		e.g. 1 = tenths place, 3 = thousandths place
	 *		e.g. -1 = tens place, -3 = thousands place
	 * 
	...
	public static String roundTo(String numStr, int decimalsToRoundTo) 
	{
		...
		{ //if we are rounding before the decimal place we must remove it if it exists then add 0s until it matches up correctly
