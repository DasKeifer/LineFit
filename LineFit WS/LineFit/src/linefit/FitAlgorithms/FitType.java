...
/**
 * This enumeration is used to keep track of the FitType and handles its basic functions that
 * allow it to be treated as a string or a number
 * 
 * <ul>
 * <li> 0 - Don't show fit
...
public enum FitType 
{
	NONE("No Fit"), REGULAR("Regular Fit"), X_ERROR("X Error Fit"), Y_ERROR("Y Error Fit"), BOTH_ERRORS("X&Y Error Fit");
	
    /** The String that will be displayed when toString is called and the String that shows up in the drop down to select the FitType */
    ...
    /**
     * This overrides the to String method so that it will show the display string in the JComboBox instead of teh Enum name
     */
    @Override
